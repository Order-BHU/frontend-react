...
import { orderType, menuItem } from "@/interfaces/restaurantType";
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{pendingOrderState.length}</div>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{acceptedOrderState.length}</div>
                            <p className="text-xs text-muted-foreground">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold">{menuItemArrayState.length}</div>
                            <p className="text-xs text-muted-foreground">
                                Available items
                            </p>
                        </CardContent>
                    ...
                    <Tabs value={activeTab} onValueChange={(value) => setActiveTab(value as TabType)}>
                        ...
                        <div className="p-6">
                            <TabsContent value="orders" className="space-y-6">
                                <RestaurantOrdersTab
                                    acceptedOrderState={acceptedOrderState}
                            ...
                            <TabsContent value="menu" className="space-y-6">
                                <RestaurantMenuTab
                                    menuItemArrayState={menuItemArrayState}
                                    setmenuItemArray={setmenuItemArray}
                                />
                            </TabsContent>
