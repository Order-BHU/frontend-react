...
import { Transaction } from "@/components/restaurantTransactionCard";
...
const RestaurantFinancialTab: React.FC = () => {
    ...
    const totalRevenue = transactionsData?.reduce((sum: number, transaction: Transaction) => {
    ...
    return (
        <div className="space-y-8">
            ...
            <motion.div
                ...
                className="space-y-6"
            >
                <h3 className="text-2xl font-bold text-secondary-900">Recent Transactions</h3>
