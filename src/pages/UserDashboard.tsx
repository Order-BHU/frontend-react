...
const userOrders = [
  { id: '1', restaurant: 'Burger Palace', items: ['Cheeseburger', 'Fries'], total: '₦3,500', status: 'Delivered', date: '2023-06-15' },
  { id: '2', restaurant: 'Pizza Heaven', items: ['Pepperoni Pizza'], total: '₦4,200', status: 'In Transit', date: '2023-06-14' },
  { id: '3', restaurant: 'Sushi Sensation', items: ['California Roll', 'Miso Soup'], total: '₦5,500', status: 'Preparing', date: '2023-06-13' },
]
