            ...
            <div className="p-6 flex flex-col sm:flex-row items-center gap-6">
              ...
              <div className="flex-grow text-center sm:text-left">
                ...
                <div className="text-sm text-secondary-500">
                  <p>Owner: {restaurantProfile.owner}</p>
                  <p>Contact: {restaurantProfile.contact}</p>
                </div>
              </div>
              <div className="flex-shrink-0">
                <button
                      ...
                      {pendingOrders.map((order) => (
                        ...
                        >
                          ...
                          <div className="flex justify-end mt-4 space-x-3">
                            <button className="inline-flex items-center justify-center px-4 py-2 rounded-lg text-white bg-red-500 hover:bg-red-600 transition-colors text-sm">
                        ...
                        >
                          ...
                          <div className="flex justify-end mt-4">
                            <button className="inline-flex items-center justify-center px-4 py-2 rounded-lg text-white bg-green-600 hover:bg-green-700 shadow-sm transition-colors text-sm">
                              <FiTruck className="mr-1" /> Mark as Delivered
                            </button>
                          </div>
                        </div>
                      ))}
